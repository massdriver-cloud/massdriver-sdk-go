// Package scalars provides marshalers and types for Massdriver's custom GraphQL
// scalars. Genqlient is configured (via massdriver/internal/gen/genqlient.yaml) to
// route the JSON, Map, and Cursor scalars through this package.
package scalars
