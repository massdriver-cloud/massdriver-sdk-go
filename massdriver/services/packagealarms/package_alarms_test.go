...
func TestCreateAlarm(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := svc.Create(context.Background(), "pkg-abc", &input)
			if tt.expectErr {
				require.Error(t, err)
			} else {
...
func TestGetAlarm(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := svc.Get(context.Background(), "pkg-abc", "alarm-xyz")
...
func TestUpdateAlarm(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := svc.Update(context.Background(), "pkg-abc", "alarm-xyz", &input)
			if tt.expectErr {
				require.Error(t, err)
			} else {
				require.NoError(t, err)
...
func TestDeleteAlarm(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := svc.Delete(context.Background(), "pkg-abc", "alarm-xyz")
			if tt.expectErr {
				require.Error(t, err)
			} else {
				require.NoError(t, err)
